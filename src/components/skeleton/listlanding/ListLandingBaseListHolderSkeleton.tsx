...
const ListLandingBaseListHolderSkeleton = () => {
   ...
   return (
      <div className="w-full pointer-events-auto h-[50%] overflow-y-auto  [&::-webkit-scrollbar-thumb]:rounded-md [&::-webkit-scrollbar-thumb]:bg-front1 [&::-webkit-scrollbar-track]:rounded-md [&::-webkit-scrollbar-track]:bg-backg2">
